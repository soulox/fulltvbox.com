...
- [P2] Why streaming devices got more expensive in 2026 (and what it means for buying one now) — category: whats-new — intent: "why are streaming devices more expensive 2026" — surfaced 2026-09-14: memory/chip supply constraints are pushing up device prices across Roku/Fire TV/Google TV/Apple TV; ties into buying-guide picks, no fabricated pricing
- [P2] Fire TV sideloading broken on Fire OS 7/8: what's going on and how to fix it — category: troubleshooting — intent: "fire tv sideload not working fire os 8" — surfaced 2026-09-14: a recent Fire OS 7/8 bug is blocking sideloaded APKs; distinct from the existing fire-tv-stick-slow-fixes guide
- [P3] Plex's new Fire TV interface: what changed and how to switch back — category: troubleshooting — intent: "plex new interface fire tv how to go back" — surfaced 2026-09-14: Plex's redesigned Fire TV/TV navigation buried menus and drew backlash; Plex is rolling a left-nav preview back in — site has a Plex Pi server tutorial but nothing on the client-side redesign
