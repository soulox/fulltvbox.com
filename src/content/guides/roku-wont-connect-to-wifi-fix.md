...
faq:
  ...
  - question: "What is Roku error code 014?"
    answer: "Error 014 means the Roku found your network but couldn't connect — almost always an incorrect Wi-Fi password or a weak signal. Re-enter the password carefully (it's case-sensitive) and move the Roku closer to the router."
  - question: "Why does my Roku connect but say no internet?"
    answer: "That means the Roku reached your router but the router has no working internet connection. Restart your modem and router, and check that other devices can get online. If they can't, the problem is your internet service, not the Roku."
  - question: "How do I restart my Roku?"
    answer: "Go to Settings → System → Power → System restart, or simply unplug the Roku for 30 seconds and plug it back in. A restart clears most temporary network glitches."
---
---
...
1. **Restart the Roku and your router** (unplug both 30 seconds).
2. **Re-enter your Wi-Fi password** — carefully, it's case-sensitive.
3. **Move the Roku closer to the router** (or remove obstructions).
4. **Check other devices** can get online to isolate the problem.
5. **Forget and rejoin** the network.
6. **Factory reset** the Roku as a last resort.
...
- For a Roku far from the router, a **wired Roku** like the [Roku Ultra](/reviews/roku-ultra-2024) (which has an Ethernet port) sidesteps Wi-Fi entirely, as does a mesh Wi-Fi system.
...
If you've confirmed the password, signal is strong, and other devices are online but the Roku still won't connect, the unit's Wi-Fi radio may be failing — especially on older models. A modern replacement is inexpensive; see our [best cheap streaming devices](/guides/best-cheap-streaming-device-under-50-2026), or step up to the Ethernet-equipped [Roku Ultra](/reviews/roku-ultra-2024) to avoid Wi-Fi issues for good. For broader playback problems, our [buffering fix guide](/guides/why-streaming-keeps-buffering-fix) covers the rest.
